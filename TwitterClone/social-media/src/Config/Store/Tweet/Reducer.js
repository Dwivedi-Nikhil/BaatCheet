import { FIND_TWEET_BY_ID_REQUEST, FIND_TWEET_BY_ID_SUCCESS, GET_ALL_TWEETS_SUCCESS, GET_USERS_TWEET_SUCCESS, LIKE_TWEET_REQUEST, REPLY_TWEET_SUCCESS, RETWEET_REQUEST, RETWEET_SUCCESS, TWEET_CREATE_REQUEST, TWEET_DELETE_REQUEST, USER_LIKE_TWEET_REQUEST } from "./ActionType";
        ...
        case GET_USERS_TWEET_SUCCESS:
         ...
         case USER_LIKE_TWEET_SUCCESS:
            ...
            return{
                ...
                ) //From state.tweets, remove the tweet that are in action.paylod's id 
            }; 
